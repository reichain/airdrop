...
var AirdropMetaData = &bind.MetaData{
	ABI: "[{\"inputs\":[{\"internalType\":\"address\",\"name\":\"user\",\"type\":\"address\"},{\"internalType\":\"uint256\",\"name\":\"id\",\"type\":\"uint256\"},{\"internalType\":\"uint256\",\"name\":\"amount\",\"type\":\"uint256\"},{\"internalType\":\"uint256\",\"name\":\"deadline\",\"type\":\"uint256\"}],\"name\":\"hash\",\"outputs\":[{\"internalType\":\"bytes32\",\"name\":\"\",\"type\":\"bytes32\"}],\"stateMutability\":\"pure\",\"type\":\"function\"}]",
}
...
// Hash is a free data retrieval call binding the contract method 0x98231d07.
//
// Solidity: function hash(address user, uint256 id, uint256 amount, uint256 deadline) pure returns(bytes32)
func (_Airdrop *AirdropCaller) Hash(opts *bind.CallOpts, user common.Address, id *big.Int, amount *big.Int, deadline *big.Int) ([32]byte, error) {
	var out []interface{}
	err := _Airdrop.contract.Call(opts, &out, "hash", user, id, amount, deadline)
...
//
// Solidity: function hash(address user, uint256 id, uint256 amount, uint256 deadline) pure returns(bytes32)
func (_Airdrop *AirdropSession) Hash(user common.Address, id *big.Int, amount *big.Int, deadline *big.Int) ([32]byte, error) {
	return _Airdrop.Contract.Hash(&_Airdrop.CallOpts, user, id, amount, deadline)
}

// Hash is a free data retrieval call binding the contract method 0x98231d07.
//
// Solidity: function hash(address user, uint256 id, uint256 amount, uint256 deadline) pure returns(bytes32)
func (_Airdrop *AirdropCallerSession) Hash(user common.Address, id *big.Int, amount *big.Int, deadline *big.Int) ([32]byte, error) {
	return _Airdrop.Contract.Hash(&_Airdrop.CallOpts, user, id, amount, deadline)
}
